 ...
 */
package com.epam.mapreduce.pi.math;

import java.util.ArrayList;
import java.util.List;

import com.epam.mapreduce.pi.Combinable;
import com.epam.mapreduce.pi.Container;
import com.epam.mapreduce.pi.Util;
...
public class Summation implements Container<Summation>, Combinable<Summation> {
  ...
  public <T extends Container<Summation>> List<Summation> remainingTerms(List<T> sorted) {
    final List<Summation> results = new ArrayList<>();
